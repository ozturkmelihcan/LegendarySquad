...
import static com.melihcan.legendarysquad.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(LegendarySquadException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(LegendarySquadException exception){
